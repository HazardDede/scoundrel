...
from scoundrel.models import Monster, Potion, Weapon, Suit
...
def test_standard_builder_total_count(builder):
    ...
    deck = builder.build_deck(shuffle=False)
...
def test_standard_builder_shuffling_logic(builder):
    ...
    deck_ordered = builder.build_deck(shuffle=False)
    deck_shuffled = builder.build_deck(shuffle=True)
...
def test_standard_builder_deterministic_without_shuffle(builder):
    ...
    deck_1 = builder.build_deck(shuffle=False)
    deck_2 = builder.build_deck(shuffle=False)
